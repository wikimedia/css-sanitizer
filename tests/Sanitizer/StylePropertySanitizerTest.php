...
class StylePropertySanitizerTest extends TestCase {
	...
	public static function provideDeclarations() {
		return [
			...
			[ 'shape-outside: xywh( 10px 10px 10px 10px round 1px )' ],
			[ 'shape-outside: rect( 10px 10px 20px 20px round 1px )' ],
			...
			[ 'shape-outside: path( evenodd, "M 100 100 L 300 100 L 200 300 z" )' ],
			...
			// cssLists3
			// Test cases adapted from web-platform-tests
			[ 'content: counter(foo, none)', 'bad-value-for-property' ],
			[ 'content: counters(foo, "", none)', 'bad-value-for-property' ],
			[ 'content: counter(foo, unset)', 'bad-value-for-property' ],
			[ 'content: counters(foo, "", unset)', 'bad-value-for-property' ],
			[ 'content: counter(foo, initial)', 'bad-value-for-property' ],
			[ 'content: counters(foo, "", initial)', 'bad-value-for-property' ],
			[ 'content: counter(foo, inherit)', 'bad-value-for-property' ],
			[ 'content: counters(foo, "", inherit)', 'bad-value-for-property' ],
			[ 'content: "z" counter(foo, none)', 'bad-value-for-property' ],
			[ 'content: "z" counters(foo, "", none)', 'bad-value-for-property' ],
			[ 'content: "z" counter(foo, unset)', 'bad-value-for-property' ],
			[ 'content: "z" counters(foo, "", unset)', 'bad-value-for-property' ],
			[ 'content: "z" counter(foo, initial)', 'bad-value-for-property' ],
			[ 'content: "z" counters(foo, "", initial)', 'bad-value-for-property' ],
			[ 'content: "z" counter(foo, inherit)', 'bad-value-for-property' ],
			[ 'content: "z" counters(foo, "", inherit)', 'bad-value-for-property' ],
			[ 'content: counter(foo, none) "z"', 'bad-value-for-property' ],
			[ 'content: counters(foo, "", none) "z"', 'bad-value-for-property' ],
			[ 'content: counter(foo, unset) "z"', 'bad-value-for-property' ],
			[ 'content: counters(foo, "", unset) "z"', 'bad-value-for-property' ],
			[ 'content: counter(foo, initial) "z"', 'bad-value-for-property' ],
			[ 'content: counters(foo, "", initial) "z"', 'bad-value-for-property' ],
			[ 'content: counter(foo, inherit) "z"', 'bad-value-for-property' ],
			[ 'content: counters(foo, "", inherit) "z"', 'bad-value-for-property' ],
			[ 'counter-increment: none chapter', 'bad-value-for-property' ],
			[ 'counter-increment: 3', 'bad-value-for-property' ],
			[ 'counter-increment: 99 imagenum', 'bad-value-for-property' ],
			[ 'counter-increment: section -1, imagenum 99', 'bad-value-for-property' ],
			[ 'counter-increment: section 3.14', 'bad-value-for-property' ],
			[ 'counter-increment: inherit 1', 'bad-value-for-property' ],
			[ 'counter-increment: initial 1', 'bad-value-for-property' ],
			[ 'counter-increment: unset 1', 'bad-value-for-property' ],
			[ 'counter-increment: default 1', 'bad-value-for-property' ],
			[ 'counter-increment: revert 1', 'bad-value-for-property' ],
			[ 'counter-increment: none' ],
			[ 'counter-increment: chapter' ],
			[ 'counter-increment: section -1' ],
			[ 'counter-increment: first -1 second third 99' ],
			[ 'counter-increment: section calc(1)' ],
			[ 'counter-increment: section calc(-2.5)' ],
			[ 'counter-increment: section calc(10 + (5 * sign(2cqw - 10px)))' ],
			[ 'counter-reset: none chapter', 'bad-value-for-property' ],
			[ 'counter-reset: 3', 'bad-value-for-property' ],
			[ 'counter-reset: 99 imagenum', 'bad-value-for-property' ],
			[ 'counter-reset: section -1, imagenum 99', 'bad-value-for-property' ],
			[ 'counter-reset: section 3.14', 'bad-value-for-property' ],
			[ 'counter-reset: inherit 0', 'bad-value-for-property' ],
			[ 'counter-reset: initial 0', 'bad-value-for-property' ],
			[ 'counter-reset: unset 0', 'bad-value-for-property' ],
			[ 'counter-reset: default 0', 'bad-value-for-property' ],
			[ 'counter-reset: revert 0', 'bad-value-for-property' ],
			[ 'counter-reset: none' ],
			[ 'counter-reset: chapter' ],
			[ 'counter-reset: chapter chapter 9' ],
			[ 'counter-reset: section -1' ],
			[ 'counter-reset: first -1 second third 99' ],
			[ 'counter-reset: section calc(1)' ],
			[ 'counter-reset: section calc(-2.5)' ],
			[ 'counter-reset: section calc(10 + (5 * sign(2cqw - 10px)))' ],
			[ 'counter-set: none chapter', 'bad-value-for-property' ],
			[ 'counter-set: 3', 'bad-value-for-property' ],
			[ 'counter-set: 99 imagenum', 'bad-value-for-property' ],
			[ 'counter-set: section -1, imagenum 99', 'bad-value-for-property' ],
			[ 'counter-set: section 3.14', 'bad-value-for-property' ],
			[ 'counter-set: inherit 2', 'bad-value-for-property' ],
			[ 'counter-set: initial 2', 'bad-value-for-property' ],
			[ 'counter-set: unset 2', 'bad-value-for-property' ],
			[ 'counter-set: default 2', 'bad-value-for-property' ],
			[ 'counter-set: revert 2', 'bad-value-for-property' ],
			[ 'counter-set: none' ],
			[ 'counter-set: chapter' ],
			[ 'counter-set: section -1' ],
			[ 'counter-set: first -1 second third 99' ],
			[ 'counter-set: section calc(1)' ],
			[ 'counter-set: section calc(-2.5)' ],
			[ 'counter-set: section calc(10 + (5 * sign(2cqw - 10px)))' ],
			[ 'list-style-image: auto', 'bad-value-for-property' ],
			[ 'list-style-image: url("image.png") none', 'bad-value-for-property' ],
			[ 'list-style-image: none' ],
			[ 'list-style-image: url("image.png")' ],
			[ 'list-style-image: linear-gradient(to left bottom, red, blue)' ],
			[ 'list-style: inside disc outside', 'bad-value-for-property' ],
			[ 'list-style: square circle', 'bad-value-for-property' ],
			[ 'list-style-position: auto', 'bad-value-for-property' ],
			[ 'list-style-position: inside outside', 'bad-value-for-property' ],
			[ 'list-style-position: inside' ],
			[ 'list-style-position: outside' ],
			[ 'list-style-type: "marker string" none', 'bad-value-for-property' ],
			[ 'list-style-type: counter-Style-Name "marker string"', 'bad-value-for-property' ],
			[ 'list-style-type: symbols(cyclic)', 'bad-value-for-property' ],
			[ 'list-style-type: symbols(numeric "n")', 'bad-value-for-property' ],
			[ 'list-style-type: symbols(alphabetic "a")', 'bad-value-for-property' ],
			[ 'list-style-type: symbols("s" symbolic)', 'bad-value-for-property' ],
			// Don't know what's wrong with this, seems OK
			// [ 'list-style-type: symbols(fixed url("image.png"))', 'bad-value-for-property' ],
			[ 'list-style-type: symbols(repeating \'○\' \'●\')', 'bad-value-for-property' ],
			...
			[ 'list-style-type: "marker string"' ],
			[ 'list-style-type: "Note: "' ],
			[ 'list-style-type: counter-Style-Name' ],
			[ 'list-style-type: CounterStyleName' ],
			[ 'list-style-type: symbols(cyclic "string")' ],
			[ 'list-style-type: symbols(cyclic "○" "●")' ],
			[ 'list-style-type: symbols(fixed "1")' ],
			[ 'list-style-type: symbols(symbolic "string")' ],
			[ 'list-style-type: symbols(alphabetic "first" "second")' ],
			[ 'list-style-type: symbols(numeric "first" "second")' ],
			[ 'list-style: none' ],
			...
			[ 'list-style: none url("image.png")' ],
			[ 'list-style: url("image.png") disc' ],
			[ 'list-style: url("image.png") disc outside' ],
			[ 'list-style: square' ],
			[ 'list-style: square url("image.png") inside' ],
			[ 'list-style: square linear-gradient(red,blue) inside' ],
