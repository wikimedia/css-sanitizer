...
class StylePropertySanitizerTest extends \PHPUnit\Framework\TestCase {
	...
	public static function provideDeclarations() {
		return [
			...
			[ 'transition: foo ease-in 1s 1s, 5s linear bar, frames(1) none' ],

			// cssAnimations
			[ 'animation-name: foo, "bar", baz' ],
			[ 'animation-duration: 1s' ],
			[ 'animation-timing-function: cubic-bezier( 1, 2, 3, 4.0 ), linear, frames(4)' ],
			...
			[ 'animation: foo both infinite cubic-bezier( 1, 2, 3, 4.0 ), linear 1s, frames(4) "what?"' ],
			...
			[ 'transform: translate3d( 10%, 30%, 5px )' ],
